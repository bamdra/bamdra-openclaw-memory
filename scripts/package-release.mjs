...
writeFileSync(
  ...
  [
    ...
    "- npm install of bamdra-openclaw-memory can auto-provision bamdra-user-bind into the OpenClaw extensions directory",
    "- the same install flow also stages bamdra-memory-vector locally so the knowledge layer is ready immediately",
    "- bamdra-openclaw-memory can auto-create ~/.openclaw/memory when it is missing",
    "",
    "Optional enhancement:",
    "- add bamdra-memory-vector only when you want lightweight semantic retrieval",
    "",
